...
def get_logger(filename, mode="a"):
    ...
    # If the code is run multiple times, handlers will be duplicated in the logger,
    # so existing handlers need to be removed each time
...
def plot_log(fileroot, x_begin=None, x_end=None):
    ...
    plt.clf()
    plt.plot(
        step[x_begin // print_freq : x_end // print_freq],
